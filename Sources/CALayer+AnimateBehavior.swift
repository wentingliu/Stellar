...
extension CALayer: DriveAnimateBehaviors {
    ...
    //MARK: Basic
    private func createBasicAnimationWithType(_ type: AnimationSubType, step: AnimationStep) -> UIDynamicBehavior {
    ...
    private func createSnapAnimationWithType(_ type: AnimationSubType, damping: CGFloat) -> UIDynamicBehavior {
    ...
    //MARK: Attachment
    private func createAttachmentAnimationWithType(_ type: AnimationSubType, damping: CGFloat, frequency: CGFloat) -> UIDynamicBehavior {
        var behavior: UIDynamicBehavior!
    ...
    //MARK: Gravity
    private func createGravityAnimationWithType(_ type: AnimationSubType, magnitude: Double) -> UIDynamicBehavior {
        var behavior: UIDynamicBehavior!
